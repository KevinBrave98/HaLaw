                        ...
                        <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
                            <div class="d-flex align-items-center mb-2 mb-md-0 card-info-wrapper">
                                @if ($riwayat->pengacara->foto_pengacara)
                                    <img src="{{ asset('storage/' . $riwayat->pengacara->foto_pengacara) }}"
                                        alt="Foto {{ $riwayat->pengacara->nama_pengacara }}"
                                        class="lawyer-photo">
                                @else
                                ...
                                <div class="ms-3">
                                    ...
                                    @if ($riwayat->pesans->last())
                                        <small class="text-muted last-message">{{ $riwayat->pesans->last()->teks }}</small>
                                    @endif
                                </div>
                            </div>
