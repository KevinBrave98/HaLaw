...
<x-layout_lawyer>
    ...
    <div class="w-auto container mt-5 d-flex justify-content-center align-items-center flex-column"
        ...
        <div class="d-flex justify-content-center align-items-center mb-5"
            ...
            <i class="bi bi-check-lg" style="color: white; font-size: 1.5rem;"></i>
        </div>
        <div class="container d-flex row justify-content-center align-items-center text-center">
            <h4 class="text-muted">Penarikan Dana Berhasil</h4>
            <h1 class="fw-bold" style="color: #6C4521;">Rp.51.000,00</h1>
        </div>
    </div>
