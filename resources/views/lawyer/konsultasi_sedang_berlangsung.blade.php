    ...
    <div class="card shadow-sm mb-3" style="border: 1px solid #B99010; background-color: #fdf5ee;">
        <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
            <div class="d-flex align-items-center mb-2 mb-md-0">
                <img src="{{ asset($riwayat->pengguna->nik_pengguna) }}" class="rounded-circle" style="width: 80px; height: 80px; object-fit: cover; border: 1px solid #ddd;">
                <div class="ms-3">
                    <h5 class="mb-0">{{ $riwayat->pengguna->nama_pengguna }}</h5>
                    @if($riwayat->pesans)
            ...
            <div class="d-flex gap-3">
                <a href="{{ route('consultation.lawyer', ['id' => $riwayat->id]) }}" class="text-brown fs-4 mx-4 px-4 py-2 text-decoration-none text-bold">Buka</a>
            </div>
        </div>
    </div>
    @endforeach
