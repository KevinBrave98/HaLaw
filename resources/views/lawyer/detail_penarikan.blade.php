    ...
    <div class="container mt-5">
        ...
        <form>
            ...
            <div class="mb-2 row">
                ...
                <div class="col-sm-3">
                    <input type="text" class="form-control" value="Rp50.000,00" style="border: 1px solid black;">
            ...
            <div class="mb-2 row">
                ...
                <div class="col-sm-3">
                    <input type="text" class="form-control" value="Rp1.000,00" style="border: 1px solid black;">
            ...
            <div class="row mt-5 mb-4">
                <div class="col-sm text-end">
                    <div class="d-inline-block me-3 text-end">
                        ...
                        <div class="fw-bold" style="font-size: 18px; color: #654220;">Rp51.000,00</div>
                    </div>
