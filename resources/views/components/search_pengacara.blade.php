<div class="d-flex mx-4 m-2 flex-column justify-content-center align-items-center search-container">
    ...
    <div class="position-relative d-flex flex-column w-100 justify-content-evenly more-filter">
        ...
        <div class="d-flex flex-column justify-content-evenly p-4 filter-section">
            ...
            <div class="position-relative w-50 d-flex flex-row align-items-center mt-3 gap-5 mb-5 select-specialization">
                <select>
                    <option value="0">Test 1</option>
                    <option value="1">Test 2</option>
                    <option value="2">Test 3</option>
                </select>
                <img src="{{ asset('assets/images/icon-dropdown.png') }}" alt="dropdown" srcset="" id="dropdown-icon" class="position-relative">
            </div>
            <hr>
        </div>
