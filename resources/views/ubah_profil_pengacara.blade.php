    ...
    <div class="profile-container">
            <form id="profileForm" class="form-profil" novalidate>
                <div class="form-element nama">
                    ...
                    <input id="namaLengkap" required type="text" class="form-control input-text" value="Fajar Nugroho, S. H., M.H.">
                </div>
            ...
            <div class="input-pengalaman-container">
                        ...
                        <div class="custom-checkbox">
                            <input class="form-check-input" type="checkbox" value="HAKI" id="haki">
                        ...
                        <div class="custom-checkbox">
                            <input class="form-check-input" type="checkbox" value="Lingkungan Hidup" id="lingkungan">
                            <label class="form-check-label" for="lingkungan">Hukum Lingkungan Hidup</label>
                        </div>
                        <div class="custom-checkbox">
                            <input class="form-check-input" type="checkbox" value="Kepentingan Publik" id="publik">
                            <label class="form-check-label" for="publik">Hukum Kepentingan Publik</label>
                        </div>
                        <div class="custom-checkbox">
                            <input class="form-check-input" type="checkbox" value="Ketenagakerjaan" id="ketenagakerjaan">
