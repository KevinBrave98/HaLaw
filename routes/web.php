...
Route::middleware(['user.auth'])->group(function () {
    ...
    Route::get('/chatroom/search', [ConsultationController::class, 'search'])->name('consultation.search');
...
Route::prefix('lawyer')->middleware(['lawyer.auth'])->group(function () {
    ...
    Route::get('/konsultasi/riwayat-konsultasi', [KonsultasiController::class, 'riwayatKonsultasiPengacara'])->name('lawyer.riwayat.konsultasi');
