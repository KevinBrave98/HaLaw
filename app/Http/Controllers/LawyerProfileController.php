...
class LawyerProfileController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'pendidikan' => 'string',
            'durasipengalaman' => 'required|numeric|min:0',
            'spesialisasi' => ['required', 'string', Rule::in(['Hukum Perdata', 'Hukum Pidana', 'Hukum Keluarga', 'Hukum Perusahaan', 'Hukum Hak Kekayaan Intelektual', 'Hukum Kepalitan', 'Hukum Kepentingan Publik', 'Hukum Lingkungan Hidup', 'Hukum Ketenagakerjaan', 'Hukum Tata Usaha Negara', 'Hukum Imigrasi'])],
